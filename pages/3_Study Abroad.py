...
with st.container():
    ...
    with left_column:
        st.write(
            ...
            €3,000 to €6,500 per year. Studying in Lithuania gives plenty of work opportuities especially with the pink card. In addition, being a schengen country, there is
            opportunity for you to visit 27 other countries with in the region without applying for visa during the off/holiday period. Featured programs include;
    ...
    with right_column:
        ...
        st.write(
            """
            STUDY IN AUSTRALIA:
            One of the benefits of studying in Australia is its cultural diversity. As a home to the different cultures of Oceania, some great benefits of studying
            in Australia for Nigerian students, other nationals range from world-class education to vibrant multicultural experiences and post-study opportunities.
            Australia does not fail to offer a unique blend of high-quality education with ample emphasis on research, productivity and professionalism, valuable
            work experiences, and an enriching lifestyle for international students. As with quality anywhere, there are real costs attached with tuition fees from
            AU$28,000 per year to as much as is obtainable. plus you get a 2 years Postgraduate Work Permit. Popular courses among international students include;    
            - Accountancy
            - Nursing
    ...
    with right_column:
        ...
        st.write(
            """
            STUDY IN CANADA:
            Almost everyone in the world  now knows that Canadan has the best living standadrd in the whole world; no country beats Canada in that regard. Studying
            in Canada requires tuition fees starting from as low as CAD15,000 dollars per year. However, we can guaranty and get you tuition scholarships of a
            mouth-watering CAD10,000 dollars, leaving you to pay as low CAD5,000 dollars per year and finish your Bachelor's program in 2.5 years; plus you get a 2
            years Postgraduate Work Permit. Featured programs include;
    ...
    with left_column:
        ...
        st.write(
            """
            STUDY IN INDIA: Granting that there are other programs in the field of Health Sciences, Social Sciences, Economic and Admisnistrative Sciences, we have
    ...
    with right_column:
        ...
        st.write(
            """
            STUDY IN GERMANY:
            Germany has a strong emphasis on research, and with some of the oldest institutions of learning in the world, it is well equipped to support such. To
            study in Germany can be very rewarding even from the start with tuition fees starting from €13,000 per year because it is notorious for its strong job
            market and opportunities for international students to work while studying. Studying in Germany guarantess you a mouth-watering 2 years Postgraduate
            Work Permit, leaving you to stay back and work in Germany. Featured programs include;
            - BA in Business Administration and Management
            - Humanities and Art
            - Historical Studies
            - Language Studies
    ...
    with right_column:
        ...
        st.write(
            """
            STUDY IN IRELAND:
            With qualifications equivalent to those in the UK and other countries, Ireland degrees from Ireland boast of high value in the international job market.
            In addition to enjoying your saty in one of the firendliest citieis in Europe, studying in Ireland guaantees skill development, research, and innovation
            from top class universities with tuition fees starting from as low as €9,000 per year to about €45,000 per year based on institutional differences. A
            guaranteed 2 years Postgraduate Work Permit is available to allow for a stay-back and opportunity to build a life with an additional residence permit
            within just 2 years, which is shorter than the 5 years period to get a residence permit in some countries. Featured programs include;
    ...
    with right_column:
        ...
        st.write(
            """
            STUDY IN UK:
            With very strong job prospects, high-quality education, global recognition of deggrees, almost everyone in the world  wants an opportunity to study in
            the UK. Despite the fact that it requires tuition fees as high as from £15,000 per year, the returns drives the courage to ignore the initial costs of
            getting there with a 90 percent guarantee of a greater rewarding future. In addition, most institutions give a 3 year duration to finish a Bachelor's
            program plus you get a 2 years Postgraduate Work Permit. For UK, it is a clear case of, "the end justifies the means" for most people. Featured programs
            include;
    ...
    with right_column:
        ...
        st.write(
            ...
            Simply put, "studying in USA requires even the best of brains". The tuition fees starting from as high as US$15,000 per year. However, we can guaranty
            you that no one who studies in the USA loses. Only gains are attainable, from diverse academic programs, renowned high-quality education, numerous
            opportunities for career advancements, huge high performance scholarships, sposts scholarships, university-wide scholarships, high-paying university-wide
            jobs on campus while studying, academic researcher benefits, university-wide industry-based projects incentives, mouth-watering jobs upon graduation,
            highest degree prestige and countless others, leaving you with "ONLY GAINS" when you finish your program and graduate; plus you get a 2 years Postgraduate
            Work Permit to stay-back and work too. Featured programs include;
    ...
    with right_column:
        ...
        st.write(
            ...
            Education Area and applies the Bologna Process, which ensures that degrees are recognized across Europe. Two types of pre-arrival scholarships of 20%
            and 50% are given to students before arrival on campus, which brings tuition fees to a relatively affordable amount ranging from US$5,500 per year.
            One shocking thing about Turkey is that while it doesn't give a Postgraduate Work Permit, it gives an option to apply for a CITIZENSHIP after 5 years,
            which can be exploered by students. Popular programs include;
            - Tourism Management
