...
with st.container():
    ...
    with right_column:
        st.write(
            """
            PYTHON-BASED WEBSITE DEISGN:
            With a strong desire to be unique and make a difference, one of our goals and ambition is to revolutionize and promote the use of python in Software
            Engineering as a whole, starting with website design, we are striving hard to continue to improve the usage of python in a novel way (with streamlit
            instead of flask) to desgin websites that are not only responsive too but just as good as those designed with HTML, functional as JavaScript-used and
            PhP-used websites, stylish as CSS-used websites and database driven as SQL-used websites - making sure that the python revolution is alive. Highlight
            features include;
            - Streamlit
            - Pillow
            - CSS
    ...
    with left_column:
        ...
        st.write(
            """
            PYTHON-BASED MOBILE APP DEVELOPMENT:
            With a strong desire to be unique and make a difference, one of our goals and ambition is to revolutionize and promote the use of python in Software
            Engineering as a whole, featuring mobile App development, we are striving hard to continue to improve the usage of python in a novel way to develop
            mobile Apps that are not only responsive too but just as good as those designed with Kotlin, functional as Android-used and Swift-used mobile Apps,
            stylish as flutter-used mobile Apps and database driven as SQL-used mobile Apps - making sure that the python revolution is alive. Highlight
            features include;
            - Kivy
            - Pillow
            - Tkinter
    ...
    with right_column:
        ...
        st.write(
            ...
            installation of security video door bells to guarantee visual representation of all breaches, leaving precise evidences for both plaintiffs and law
            enforcements agancies to act on. Highlight features include;
            - Long distance coverage as far as a 250 meters
